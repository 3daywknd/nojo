...
Create a new custom nojo profile by cloning an existing profile and customizing it.
...
Or:
  nojo switch-profile <new-profile-name>
```
...
- Custom profiles (builtin: false) are preserved during nojo upgrades
