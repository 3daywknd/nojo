 ...
 * Handles /nojo/prune-context command
 *
...
/**
 * Run the nojo/prune-context command
...
/**
 * nojo/prune-context intercepted slash command
 */
export const nojoPruneContext: InterceptedSlashCommand = {
  matchers: ["^\\/nojo\\/prune-context\\s*$"],
  run,
};
